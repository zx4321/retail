...
SECRET_KEY = '!4uzbg%&hbj&nu1jl#v^8s=%unk+xn@@bt2y%h5m&jx+&+bv*q'
...
JWT_AUTH = {
    ...
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'retail.utils.jwt_response_payload_handler',  # response中token的payload部分处理函数
}
...
AUTH_USER_MODEL = 'retail.UserProfile'
